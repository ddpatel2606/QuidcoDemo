...
class CircularProgressView(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    var progressBarWidth: Float = resources.getDimension(R.dimen.dimen_7dp)
        set(value) {
            field = value.dpToPx()
    ...
    var backgroundProgressBarWidth: Float = resources.getDimension(R.dimen.dimen_9dp)
        set(value) {
            field = value.dpToPx()
    ...
    private val indeterminateModeRunnable = Runnable {
        if (indeterminateMode) {
            ...
            this.progressDirectionIndeterminateMode = this.progressDirectionIndeterminateMode.reverse()
            if (this.progressDirectionIndeterminateMode.isToRight()) {
